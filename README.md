...
Previously, I contributed to engineering teams at BoomersHub and Edge N Roots, where I built scalable front end architectures and modern web platforms using React.js and Next.js.

💡 What I Do Best
• Build scalable full-stack web applications
• Design secure REST APIs and microservices
• Optimize database performance and system architecture
• Develop modern, responsive user interfaces
• Implement cloud-ready and containerized systems

🛠 Core Technical Skills
Languages - JavaScript • TypeScript • Python • PHP
Frontend Development - React.js • Next.js • Tailwind CSS • MUI • React Hook Form • Formik • Yup
Backend Development - Node.js • NestJS • Express.js • REST APIs • Microservices • JWT Authentication • Keycloak SSO • Input Validation (Zod, Joi)
Databases - PostgreSQL • MySQL • MongoDB • Schema Design • Query Optimization • Indexing
Architecture - Event-Driven Architecture • Redis Caching • Message Queues • Distributed Systems
DevOps & Cloud - AWS (EC2, S3) • Docker • Nginx • GitHub Actions • GitLab CI/CD
Monitoring & Testing - Elasticsearch • Sentry • Jest • React Testing Library • Integration Testing • Postman

🌍 I’m passionate about building impactful software, learning emerging technologies, and collaborating with global engineering teams. I continuously explore better ways to design scalable systems and modern product architectures.

I’m particularly interested in working on:
• Large-scale backend systems
• Cloud-native applications
• Modern full-stack product platforms
• Remote or international engineering teams

📩Let’s connect if you're building something exciting or looking for engineers who care about performance, scalability, and clean architecture. Email: rajudevit94@gmail.com</h3>
